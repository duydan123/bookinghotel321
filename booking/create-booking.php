                        ...
                        <div class="login-right" style="width: 100%;">
                            <form method="post" id="bookingForm" action="booking/submit.php">
                                                ...
                                                <div class="col-md-4" style="width: 200px;">
                                                    <select id="roomType" name="roomTypeIdPrice-0" class="form-control"
                                                        ...
                                                        foreach ($roomTypes as $roomType) {
                                                            ?>
                                                            <option value="<?php echo $roomType->id . '-' . $roomType->price ?>"><?php echo $roomType->name ?></option>
                                                        <?php } ?>
                                                    </select><br>
                                ...
                                <div id="step2" style="display: none;">
                                    <div>
                                        <div>
                                            <input type="text" value="" placeholder="Số điện thoại" name="mobileContact" autocomplete="off" required>
                                            <div id="mobileError" class="error" style="color: red;font-size: 10px;"></div> <!-- Thông báo lỗi số điện thoại -->
                                        </div>
                                        <div>
                                            <input type="text" value="" placeholder="Email" name="emailContact" id="email" required autocomplete="off">
                                            <div id="emailError" class="error" style="color: red;font-size: 10px;"></div> <!-- Thông báo lỗi email -->
                                        </div>
                                        <div style="padding-top: 20px">
                                            <textarea class="form-control" rows="5" cols="50" name="comment" id="packagedetails" placeholder="comment"></textarea>
                                        </div>
                                    </div>
                                    <div style="padding-top: 20px">
                                ...
                                <div id="step3" style="display: none;">
                                    <div>
                                        <div>
                                            ...
                                            <div class="payment" id="credit-card" style="padding-top: 10px">
                                                <h3>Thanh toán bằng thẻ tín dụng / Ghi nợ</h3>
                                                <input type="text" id="card-number" name="cardNumber" required onkeypress="return isNumeric(event)"
                                                ...
                                                <input type="text" id="expiration-date" name="expirationDate" required
                                                       placeholder="Ngày hết hạn: MM/YY">
                                                <input type="text" id="cvv" name="cvv" required
                                                       placeholder="Mã bảo mật (CVV/CVC): 123">
                                            </div>
                                            <div class="payment" style="display: none;padding-top: 10px" id="e-wallet" >
                                                <h3>Thanh toán bằng điện tử</h3>
                                                <input type="text" id="e-wallet-id" name="eWalletId"
                                                       placeholder="ID đăng nhập: abc@xyz.com">
                                                <input type="text" id="e-wallet-password" name="eWalletPassword"
                                                       placeholder="Mật khẩu: ********">
                                            </div>
                                            <div class="payment" style="display: none; padding-top: 10px" id="atm">
                                                <h3>Thanh toán bằng thẻ ATM nội địa</h3>
                                                <input type="text" id="bank-name" name="bankName"
                                                       placeholder="Tên ngân hàng: Ngân hàng ABC">
                                                <input type="text" id="atm-number" name="atmNumber" onkeypress="return isNumeric(event)"
                                                       placeholder="Số thẻ ATM: 1234 5678 9012 3456">
                                                <input type="text" id="atm-pin" name="atmPin"
                                                       placeholder="Mã PIN: ****">
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function sumColumn() {
        ...
        selectedOptions.forEach(function(option) {
            ...
            var isUseDeposit = "<?php echo $roomType->isUseDeposit ?>";
            var depositPercent = "<?php echo $roomType->depositPercent ?>";

            selectedData.push({
                id: selectedValues[0],
                price: selectedValues[1],
                isUseDeposit: isUseDeposit,
        ...
        for (var i = 0; i <= 10; i++) {
            ...
            if (quantity !== 0 && price !== 0 && numberDay !== 0) {
                ...
                if (isUseDeposit) {
                    priceDeposit = (price * selectedData[0].depositPercent) / 100;
            ...
            var totalRecord = isUseDeposit ? (numberDay * ((price * selectedData[0].depositPercent) / 100)) * quantity : (numberDay * price) * quantity;
