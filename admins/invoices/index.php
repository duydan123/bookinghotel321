                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tr>
                                    ...
                                    <th style="white-space: nowrap">Mua ngày</th>
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {
                                        ...
                                        <tr align="center" id="record-<?php echo $result['invoice_id'] ?>">
                                            ...
                                            <td>
                                                <a href="details.php?pkgid=<?php echo htmlentities($result['id']); ?>"><?php echo htmlentities($result['hotel_name']); ?></a>
                                            </td>
                                            <td>
                                                <?php echo htmlentities($result['payment_method_name']); ?>
                                            </td>
                                            <td><?php echo htmlentities(number_format($result['price'], 0, ',', '.')) . ' VND'; ?></td>
                                            <td>
                                            ...
                                            <td><?php
                                                ...
                                                if ($result['status'] === 'ENABLE' && $daysRemaining >= 3) {
                                                    ...
                                                    echo '<span class="label label-warning">Sắp tới hạng</span>';
