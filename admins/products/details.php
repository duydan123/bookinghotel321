                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tr>
                                    ...
                                    <th style="white-space: nowrap">tính năng</th>
                                    ...
                                    <th style="white-space: nowrap">Cho phép đặt cọc</th>
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {
                                        ...
                                        <tr id="record-<?php echo $result->id ?>">
                                            ...
                                            <td><?php echo htmlentities($result->acreage); ?></td>
                                            <td><?php echo htmlentities($result->price); ?></td>
                                            <td><?php echo htmlentities($result->totalNumber); ?></td>
                                            <td><?php echo htmlentities($result->depositPercent); ?></td>
                                            <td><?php echo htmlentities($result->isUseDeposit); ?></td>
                                            <td><?php echo htmlentities($result->priceRoot); ?></td>
                                            <td>
