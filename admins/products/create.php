...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "INSERT INTO hotels(name,type,location,ranking,description,createdAt,status,createdBy,embedLocation,convenient,isBreakfastService,famousLocation) 
            VALUES(:name,:type,:location,:ranking,:description,:createdAt,:status,:createdBy,:embedLocation,:convenient,:isBreakfastService,:famousLocation)";
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                ...
                <small>Taken from <a href="https://github.com/rstaib/jquery-steps" target="_blank">github.com/rstaib/jquery-steps</a>
                    & <a href="https://jqueryvalidation.org/" target="_blank">jqueryvalidation.org</a></small>
            </h2>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" class="form-control" name="ranking" max="5" min="1" value="5"
                                               required>
